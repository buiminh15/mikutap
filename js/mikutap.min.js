                ...
                this.resize = function() {
                    ...
                    m || ($(function() {
                        var run = (i) => {
                            if (i <= 100) {
                                setTimeout(() => {
                                    let keyRandom = Math.random() * 200;
                                    r(keyRandom, 0, true);
                                    console.log('key random:', keyRandom)
                                    run(i + 1);
                                }, 1000 / 3)
                            }
                        }
                        run(0);
                    }),$("#view").on("mousedown", t), $(window).on("mousemove", i), $(window).on("mouseup", o), $(window).on("keydown", e), $(window).on("keyup", n)), (m || window.TouchEvent) && ($("#view").on("touchstart", t), $(window).on("touchmove", i), $(window).on("touchend", o)), $("#view").css("cursor", "pointer")
                }, this.end = function() {
